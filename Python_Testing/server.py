...
def purchasePlaces():
    ...
    if competition and club:
        if placesRequired < 0:
        ...
        elif placesRequired > int(competition['placesAvailable']):
            ...
            # New competition places available.
            competition['placesAvailable'] = str(int(competition['placesAvailable']) - placesRequired)
